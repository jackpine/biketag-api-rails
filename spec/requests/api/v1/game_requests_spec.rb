...
describe 'game requests' do
  ...
  describe 'GET /api/v1/games/current_spots.json' do
    it 'returns all the games current spots' do
      get '/api/v1/games/current_spots.json', headers: authorization_headers_for_user(Seeds.user)
  ...
  describe 'GET /api/v1/games' do
    it 'returns all the games' do
      get '/api/v1/games.json', headers: authorization_headers_for_user(Seeds.user)
      expect(response).to be_success
  ...
  describe 'GET /api/v1/games/1/current_spot' do
    it 'returns the current spot' do
      get "/api/v1/games/#{Seeds.game.id}/current_spot.json", headers: authorization_headers_for_user(Seeds.user)
      expect(response).to be_success
